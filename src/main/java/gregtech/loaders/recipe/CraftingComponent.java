...
public enum CraftingComponent {
    ...
    PIPE {
        ...
        public Object getIngredient(int tier) {
            return switch(tier) {
                ...
                case IV -> new UnificationEntry(OrePrefix.pipeMedium, Materials.TungstenSteel);
    ...
    GRINDER {
        ...
        public Object getIngredient(int tier) {
            return switch(tier) {
                case ULV, LV -> new UnificationEntry(OrePrefix.gem, Materials.Diamond);
                case MV -> new UnificationEntry(OrePrefix.gem, Materials.Diamond);
    ...
    COIL_ELECTRIC {
        ...
        public Object getIngredient(int tier) {
            return switch(tier) {
                ...
                case EV -> new UnificationEntry(OrePrefix.wireGtOctal, Materials.AnnealedCopper);
                case IV -> new UnificationEntry(OrePrefix.wireGtOctal, Materials.AnnealedCopper);
